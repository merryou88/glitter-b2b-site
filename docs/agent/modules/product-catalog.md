...
## 数据与状态
- 当前产品数据数：9；`/products/` 当前展示 `performanceProducts` 中的 9 个产品
...
- 2026-09-19 至 2026-10-19 的下一批产品候选筛选记录在 `workflows/next-product-candidate-plan.md`；H2013060104 已由用户确认并进入公开产品集合，其余初筛对象仍按计划复核
