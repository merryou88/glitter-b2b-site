...
| 产品目录 | `current/product-catalog.md` | `REQ-PRODUCT-001~018` | CHG-20260915-009-product-article-schema | `src/pages/products.astro`、`src/pages/products/[slug].astro`、`src/components/ProductDetail.astro`、`src/components/ProductSchema.astro` |
