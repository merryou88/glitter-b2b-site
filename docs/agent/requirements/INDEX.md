...
| 内容数据 | `current/content-data.md` | `REQ-DATA-001~006` | CHG-20260919-001-factory-branded-video | `src/data/allProducts.js`、`src/data/blogArticles.js`、`src/data/products.json`、`public/images/**`、`products-data/original-images/**`、`products-data/original-videos/**` |
| 产品目录 | `current/product-catalog.md` | `REQ-PRODUCT-001~024` | CHG-20260918-002-products-color-moq-alignment | `src/data/allProducts.js`、`src/pages/products.astro`、`src/pages/products/[slug].astro`、`src/components/ProductDetail.astro`、`src/components/ProductSchema.astro` |
...
| 公司 / 政策页 | `current/company-pages.md` | `REQ-COMPANY-001~010` | CHG-20260919-001-factory-branded-video | `src/pages/about.astro`、`src/pages/factory.astro`、`src/pages/certifications.astro`、`src/pages/sample-policy.astro`、`src/pages/privacy.astro`、`src/pages/thank-you.astro`、`src/pages/404.astro` |
